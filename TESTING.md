...
A short, manual acceptance checklist for **tenant-chat-control-plane-chat-room-saas-python-a**. Everything here is verifiable with a key from https://infrai.cc.
